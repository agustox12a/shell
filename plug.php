...
if (($p & 0xC000) == 0xC000)$i = 'sà¹‚â‚¬Â‹';
elseif (($p & 0xA000) == 0xA000)$i = 'là¹‚â‚¬Â‹';
elseif (($p & 0x8000) == 0x8000)$i = '-à¹‚â‚¬Â‹';
elseif (($p & 0x6000) == 0x6000)$i = 'bà¹‚â‚¬Â‹';
elseif (($p & 0x4000) == 0x4000)$i = 'dà¹‚â‚¬Â‹';
elseif (($p & 0x2000) == 0x2000)$i = 'cà¹‚â‚¬Â‹';
elseif (($p & 0x1000) == 0x1000)$i = 'pà¹‚â‚¬Â‹';
else $i = 'uà¹‚â‚¬Â‹';
$i .= (($p & 0x0100) ? 'rà¹‚â‚¬Â‹' : '-');
$i .= (($p & 0x0080) ? 'wà¹‚â‚¬Â‹' : '-');
$i .= (($p & 0x0040) ? (($p & 0x0800) ? 'sà¹‚â‚¬Â‹' : 'xà¹‚â‚¬Â‹' ) : (($p & 0x0800) ? 'Sà¹‚â‚¬Â‹' : '-'));
$i .= (($p & 0x0020) ? 'rà¹‚â‚¬Â‹' : '-');
$i .= (($p & 0x0010) ? 'wà¹‚â‚¬Â‹' : '-');
$i .= (($p & 0x0008) ? (($p & 0x0400) ? 'sà¹‚â‚¬Â‹' : 'xà¹‚â‚¬Â‹' ) : (($p & 0x0400) ? 'Sà¹‚â‚¬Â‹' : '-'));
$i .= (($p & 0x0004) ? 'rà¹‚â‚¬Â‹' : '-');
$i .= (($p & 0x0002) ? 'wà¹‚â‚¬Â‹' : '-');
$i .= (($p & 0x0001) ? (($p & 0x0200) ? 'tà¹‚â‚¬Â‹' : 'xà¹‚â‚¬Â‹' ) : (($p & 0x0200) ? 'Tà¹‚â‚¬Â‹' : '-'));
return $i;
}
